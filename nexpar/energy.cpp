...
float energy_lattice(unsigned int *lattice, unsigned int lattice_size,
...
int main() {
  ...
  /*unsigned int *partition = new unsigned int[n]{4, 3, 1, 1, 0, 0, 0, 0, 0, 1};*/
  ...
  /*std::cout << "Energy : " << energy_lattice(lattice, length) << std::endl;*/

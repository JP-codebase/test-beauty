...
def main():
    ...
    n_colors_vals = read_colors_bin(filename.replace("resrel", "colors"), "I")
    
    print_resres_colors_txt(filename.replace("bin", "txt").replace("resrel", "rrc"), res_vals, rel_vals, n_colors_vals)
